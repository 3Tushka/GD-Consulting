import './clients.scss';
import clientsImage from '../../assets/icons/Group 512630.svg';

export const Clients = () => {
    return (
        <div className="clients">
            <div className="clients__title">
                <div className="clients__title__h1">
